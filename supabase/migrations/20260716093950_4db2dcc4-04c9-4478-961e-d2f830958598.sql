...
-- Enhance respond_payment_request to log audits and notify customer on status changes
...
-- Keep permissions strict (only authenticated calling their own request)
